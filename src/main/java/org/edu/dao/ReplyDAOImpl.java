...
public class ReplyDAOImpl implements IF_ReplyDAO{
	...
	@Inject
	private SqlSession sqlSession;//root context.xml에서 지정한 sql session bean(template)사용
	
	@Override
	public List<ReplyVO> selectReply(Integer bno, PageVO pageVO) {
		// 매퍼쿼리 연결
	...
	@Override
	public void updateCountReply(Integer bno) {
		// 매퍼쿼리 연결
