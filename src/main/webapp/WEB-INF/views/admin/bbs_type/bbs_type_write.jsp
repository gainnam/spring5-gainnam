  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">게시판 타입생성</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">게시판 타입생성 </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
          ...
          <div class="card card-primary">
              ...
              <label for="board_type">게시판타입</label><!-- 게시판 타입은 중복값이 있으면 안됨.id니까 -->
              <input type="text" value="" class="form-control" name="board_type" id="board_type" placeholder="게시판타입을 영문으로 입력해주세요" required>
                  ...
                  <div class="form-group">
                  	...
                  	<input type="text" value="${boardTypeVO.board_sun}" class="form-control" name="board_sun" id="board_sun" placeholder="게시판 출력 순서를 입력해 주세요" required>
                  </div>
...
<!-- 현재 JQuery코어 파일이 footer.jsp에 있기 떄문에, 아래 jQuery실행은 코어 아래쪽에 있어야 함
이렇게 상단부터 프로그램 내용을 해석-컴파일하는 과정의 언어를 인터프리터형 프로그램언어입니다. -->
<script>
